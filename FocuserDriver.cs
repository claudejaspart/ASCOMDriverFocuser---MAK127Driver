...
//
// ASCOM Focuser driver for MAK127
//
...
{
    //
    // Your driver's DeviceID is ASCOM.MAK127.Focuser
    //
    // The Guid attribute sets the CLSID for ASCOM.MAK127.Focuser
    // The ClassInterface/None attribute prevents an empty interface called
    // _MAK127 from being created and used as the [default] interface
    //
    ...
    /// ASCOM Focuser Driver for MAK127.
    /// </summary>
    [Guid("b4585b63-bccd-40f0-b200-705bbe64a3ea")]
    ...
    public class Focuser : IFocuserV3
    {
        ...
        /// </summary>
        internal static string driverID = "ASCOM.MAK127.Focuser";
        // TODO Change the descriptive string for your driver then remove this line
        /// <summary>
        /// Driver description that displays in the ASCOM Chooser.
        /// </summary>
        private static string driverDescription = "ASCOM Focuser Driver for MAK127.";

        internal static string comPortProfileName = "COM Port"; // Constants used for Profile persistence
        internal static string comPortDefault = "COM9";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MAK127"/> class.
        /// Must be public for COM registration.
        /// </summary>
        public Focuser()
        {
            tl = new TraceLogger("", "MAK127");
        ...
        private const int focuserSteps = 0;
