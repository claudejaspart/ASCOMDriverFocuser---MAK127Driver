...
;
[Setup]
AppID={{6a229981-c5f5-419a-885a-7fc9b7cbf6c6}
AppName=ASCOM MAK127Focuser Focuser Driver
AppVerName=ASCOM MAK127Focuser Focuser Driver 1.0.0
AppVersion=1.0.0
...
OutputDir="."
OutputBaseFilename="MAK127Focuser Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Focuser\MAK127Focuser"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Focuser\MAK127Focuser"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "C:\Users\Claude\OneDrive\Documents\ASCOM DEV\MAK127Driver\bin\Release\ASCOM.MAK127.Focuser.dll"; DestDir: "{app}"
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "C:\Users\Claude\OneDrive\Documents\ASCOM DEV\MAK127Driver\ReadMe.htm"; DestDir: "{app}"; Flags: isreadme
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.MAK127.Focuser.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.MAK127.Focuser.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.MAK127.Focuser.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.MAK127.Focuser.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.MAK127.Focuser.dll"""; Flags: runhidden 64bit; Check: IsWin64
